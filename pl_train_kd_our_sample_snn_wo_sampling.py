...
class LitModel(pl.LightningModule):
    ...
    def training_step(self, batchs):
        ...
        loss = self.criterion(out, gt) +  self.hyper_cam*l3 
...
def parse_args():
    ...
    #  nohup python pl_train_kd_our_sample_snn_wo_sampling.py --config config/cars196/plt_our_kdtrain_snn_cars.yml --print-yaml &
