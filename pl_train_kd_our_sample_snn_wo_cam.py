...
class LitModel(pl.LightningModule):
    ...
    def training_step(self, batchs):
        ...
        #  self.hyper_cam*l3 
        loss = self.criterion(out, gt) + soft_loss_smooth(out,out_t,noise_weight=self.noise_weight) + sample_loss + external_loss + internal_loss  + roi_kl_distill_loss(out, out_t_sample,num_rois=10,T=2.0)
