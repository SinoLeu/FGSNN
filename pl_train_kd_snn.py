...
def load_teacher_model(args):
    backbone = timm.create_model(args.tea_arch, pretrained=False, num_classes=args.num_classes)
...
class LitModel(pl.LightningModule):
    ...
    def training_step(self, batch):
        ...
        loss = self.criterion(out, gt) + soft_kd_loss(out,out_t) 
...
def parse_args():
    ...
    args = parse_args_yml('config/cars196/plt_kdtrain_snn_cars.yml')
